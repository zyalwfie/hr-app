        ...
        <nav class="mx-auto flex w-full basis-full items-center px-4 sm:px-6">
            <div class="me-5 flex items-center lg:me-0 lg:hidden">
                ...
                <div class="ms-1 lg:hidden">
                    <!-- Templates Dropdown -->
                    <div class="hs-dropdown relative inline-flex [--auto-close:inside] [--scope:window]">
                        <button id="hs-dropdown-preview-navbar" type="button"
                            class="hs-dropdown-toggle focus:outline-hidden group relative flex size-8 items-center justify-center rounded-full text-xs text-gray-800 hover:bg-gray-100 focus:bg-gray-100 disabled:pointer-events-none disabled:opacity-50 dark:text-neutral-200 dark:hover:bg-neutral-700 dark:focus:bg-neutral-700"
                        ...
                        <!-- Dropdown -->
                        <div class="hs-dropdown-menu hs-dropdown-open:opacity-100 min-w-90 md:w-125 duration z-61 hidden w-full overflow-hidden rounded-xl border border-gray-200 bg-white opacity-0 shadow-xl transition-[opacity,margin] dark:border-neutral-700 dark:bg-neutral-800"
                            role="menu" aria-orientation="vertical" aria-labelledby="hs-dropdown-preview-navbar">
                            <!-- Tab -->
                            <div
                                class="flex flex-wrap items-center justify-between gap-3 border-b border-gray-200 p-3 pb-0 dark:border-neutral-700">
                                <!-- Nav Tab -->
                                <nav class="flex gap-1" aria-label="Tabs" role="tablist" aria-orientation="horizontal">
                                    <button type="button"
                                        class="hs-tab-active:after:bg-gray-800 hs-tab-active:text-gray-800 focus:outline-hidden dark:hs-tab-active:text-neutral-200 dark:hs-tab-active:after:bg-neutral-400 focus:outline-hidden relative mb-2 inline-flex items-center justify-center gap-x-2 rounded-lg px-2 py-1.5 text-sm text-gray-500 after:pointer-events-none after:absolute after:inset-x-2 after:-bottom-2 after:z-10 after:h-0.5 hover:bg-gray-100 hover:text-gray-800 focus:bg-gray-100 disabled:pointer-events-none disabled:pointer-events-none disabled:opacity-50 disabled:opacity-50 dark:text-neutral-500 dark:hover:bg-neutral-700 dark:hover:text-neutral-300 dark:focus:bg-neutral-700"
                                        id="hs-pmn-item-pro" aria-selected="false" data-hs-tab="#hs-pmn-pro"
                                        aria-controls="hs-pmn-pro" role="tab">
                                        Pro
                                    </button>
                                    <button type="button"
                                        class="hs-tab-active:after:bg-gray-800 hs-tab-active:text-gray-800 focus:outline-hidden dark:hs-tab-active:text-neutral-200 dark:hs-tab-active:after:bg-neutral-400 focus:outline-hidden active relative mb-2 inline-flex items-center justify-center gap-x-2 rounded-lg px-2 py-1.5 text-sm text-gray-500 after:pointer-events-none after:absolute after:inset-x-2 after:-bottom-2 after:z-10 after:h-0.5 hover:bg-gray-100 hover:text-gray-800 focus:bg-gray-100 disabled:pointer-events-none disabled:pointer-events-none disabled:opacity-50 disabled:opacity-50 dark:text-neutral-500 dark:hover:bg-neutral-700 dark:hover:text-neutral-300 dark:focus:bg-neutral-700"
                                ...
                                <div class="mb-2 flex items-center gap-x-0.5">
                                    <button type="button"
                                        class="hs-dark-mode hs-dark-mode-active:hidden focus:outline-hidden flex shrink-0 items-center justify-center gap-x-1 text-xs text-gray-500 hover:text-gray-800 focus:text-gray-800 dark:text-neutral-400 dark:hover:text-neutral-200 dark:focus:text-neutral-200"
                                    ...
                                    <button type="button"
                                        class="hs-dark-mode hs-dark-mode-active:flex focus:outline-hidden hidden shrink-0 items-center justify-center gap-x-1 text-xs text-gray-500 hover:text-gray-800 focus:text-gray-800 dark:text-neutral-400 dark:hover:text-neutral-200 dark:focus:text-neutral-200"
                            ...
                            <div id="hs-pmn-pro" class="hidden" role="tabpanel" aria-labelledby="hs-pmn-item-pro">
                                ...
                                <div class="flex flex-wrap items-center justify-between gap-3 p-3">
                                    <span
                                        class="block text-sm font-semibold text-gray-800 dark:text-neutral-200">Templates
                                        (21)</span>

                                    <div class="ms-auto">
                                        <a class="focus:outline-hidden group flex items-center gap-x-1 rounded-md bg-gray-800 px-2.5 py-2 text-[13px] text-white hover:bg-gray-900 focus:bg-gray-900 disabled:pointer-events-none disabled:opacity-50 dark:bg-white dark:text-neutral-800 dark:hover:bg-neutral-200 dark:focus:bg-neutral-200"
                                            href="../pro/pricing.html">
                                            Purchase
                                            <svg class="hidden size-3.5 shrink-0 transition group-hover:translate-x-0.5 md:inline-block"
                                                xmlns="http://www.w3.org/2000/svg" width="24" height="24"
                                                viewBox="0 0 24 24" fill="none" stroke="currentColor"
                                                stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
                                                <path
                                                    class="lg:-translate-x-1 lg:opacity-0 lg:transition lg:group-hover:translate-x-0 lg:group-hover:opacity-100 lg:group-focus:translate-x-0 lg:group-focus:opacity-100"
                                                    d="M5 12h14" />
                                                <path
                                                    class="lg:-translate-x-1.5 lg:transition lg:group-hover:translate-x-0 lg:group-focus:translate-x-0"
                                                    d="m12 5 7 7-7 7" />
                                            </svg>
                                        </a>
                                    </div>
                                ...
                                <!-- Body -->
                                <div
                                    class="sm:max-h-100 max-h-64 overflow-y-auto px-3 [&::-webkit-scrollbar-thumb]:rounded-full [&::-webkit-scrollbar-thumb]:bg-gray-300 dark:[&::-webkit-scrollbar-thumb]:bg-neutral-500 [&::-webkit-scrollbar-track]:bg-gray-100 dark:[&::-webkit-scrollbar-track]:bg-neutral-700 [&::-webkit-scrollbar]:w-2">
                                    <!-- Grid -->
                                    <div class="grid grid-cols-2 gap-2 sm:grid-cols-3">
                                        <!-- Link -->
                                        <a class="focus:outline-hidden relative flex flex-col items-center justify-center gap-y-3 rounded-xl p-3 transition hover:bg-gray-100 focus:bg-gray-100 dark:hover:bg-neutral-700 dark:focus:bg-neutral-700"
                                            href="../pro/dashboard/index.html">
                                            <img class="shadow-xs w-28 rounded-lg dark:hidden"
                                                src="../assets/img/demo-previews/img1.webp" alt="Main Page">
                                            <img class="shadow-xs hidden w-28 rounded-lg dark:block"
                                                src="../assets/img/demo-previews-dark/img1.webp" alt="Main Page">

                                            <p class="text-center text-sm text-gray-800 dark:text-neutral-400">
                                                Dashboard
                                            </p>
                                        </a>
                                        <!-- End Link -->
                                        ...
                                        <a class="focus:outline-hidden relative flex flex-col items-center justify-center gap-y-3 rounded-xl p-3 transition hover:bg-gray-100 focus:bg-gray-100 dark:hover:bg-neutral-700 dark:focus:bg-neutral-700"
                                            ...
                                            <div class="end-[3px]'> <span class= absolute -top-px"inline-flex
                                                items-center gap-x-1.5 rounded-full bg-emerald-100 px-2 py-0.5 text-xs
                                                font-medium text-emerald-800 dark:bg-emerald-900 dark:text-emerald-500">
                                                New</span>
                                            </div>
                                        </a>
                                        <!-- End Link -->
                                ...
                                <!-- Footer -->
                                <div class="flex flex-wrap items-center justify-center gap-0.5 p-3">
                                    <div
                                        class="relative ms-1 ps-2 before:absolute before:start-0 before:top-1/2 before:hidden before:h-4 before:w-px before:-translate-y-1/2 before:bg-gray-200 first:ms-0 first:ps-0 first:before:hidden md:before:block dark:before:bg-neutral-700">
                                        <a class="focus:outline-hidden group flex items-center gap-x-1.5 rounded-md px-2 py-1.5 text-[13px] text-gray-800 hover:bg-gray-100 focus:bg-gray-100 disabled:pointer-events-none disabled:opacity-50 dark:text-neutral-200 dark:hover:bg-neutral-700 dark:focus:bg-neutral-700"
                                            href="../pro/index.html">
                                            Main page
                                            <svg class="size-3.5 shrink-0" xmlns="http://www.w3.org/2000/svg"
                                                ...
                                                <path
                                                    class="lg:-translate-x-1 lg:opacity-0 lg:transition lg:group-hover:translate-x-0 lg:group-hover:opacity-100"
                                                    d="M5 12h14" />
                                                <path
                                                    class="lg:-translate-x-1.5 lg:transition lg:group-hover:translate-x-0"
                                                    d="m12 5 7 7-7 7" />
                                            </svg>
                                        </a>
                                    </div>
            ...
            <div class="ms-auto flex w-full items-center justify-end gap-x-1 md:justify-between md:gap-x-3">
                ...
                <div class="hidden md:block">
                    ...
                    <div class="relative">
                        ...
                        <input type="text"
                            class="focus:outline-hidden block w-full rounded-lg border-gray-200 bg-white py-2 pe-16 ps-10 text-sm checked:border-blue-500 focus:border-blue-500 focus:ring-blue-500 disabled:pointer-events-none disabled:opacity-50 dark:border-neutral-700 dark:bg-neutral-800 dark:text-neutral-400 dark:placeholder:text-neutral-400 dark:focus:ring-neutral-600"
                            placeholder="Search">
                        <div class="absolute inset-y-0 end-0 z-20 flex hidden items-center pe-1">
                            <button type="button"
                                class="focus:outline-hidden inline-flex size-6 shrink-0 items-center justify-center rounded-full text-gray-500 hover:text-blue-600 focus:text-blue-600 dark:text-neutral-500 dark:hover:text-blue-500 dark:focus:text-blue-500"
                                aria-label="Close">
                ...
                <div class="flex flex-row items-center justify-end gap-1">
                    <button type="button"
                        class="size-9.5 focus:outline-hidden relative inline-flex items-center justify-center gap-x-2 rounded-full border border-transparent text-sm font-semibold text-gray-800 hover:bg-gray-100 focus:bg-gray-100 disabled:pointer-events-none disabled:opacity-50 md:hidden dark:text-white dark:hover:bg-neutral-700 dark:focus:bg-neutral-700">
                        <svg class="size-4 shrink-0" xmlns="http://www.w3.org/2000/svg" width="24"
                            height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor"
                            stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
                            <circle cx="11" cy="11" r="8" />
                    ...
                    <div class="hs-dropdown relative inline-flex [--placement:bottom-right]">
                        <button id="hs-dropdown-account" type="button"
                            ...
                            aria-haspopup="menu" aria-expanded="false" aria-label="Dropdown">
                            <img class="size-9.5 shrink-0 rounded-full"
        ...
        <div class="flex items-center py-2">
            ...
            <ol class="ms-3 flex items-center whitespace-nowrap">
                <li class="flex items-center text-sm text-gray-800 dark:text-neutral-400">
                    Application Layout
                    <svg class="mx-3 size-2.5 shrink-0 overflow-visible text-gray-400 dark:text-neutral-500"
    ...
    <div id="hs-application-sidebar"
        ...
        <div class="relative flex h-full max-h-full flex-col">
            <div class="flex items-center px-6 pt-4">
                ...
                <div class="ms-2 hidden lg:block">
                    <!-- Templates Dropdown -->
                    <div class="hs-dropdown relative inline-flex [--auto-close:inside] [--scope:window]">
                        <button id="hs-dropdown-preview-sidebar" type="button"
                            class="hs-dropdown-toggle focus:outline-hidden group relative flex size-8 items-center justify-center rounded-lg text-xs text-gray-800 hover:bg-gray-100 focus:bg-gray-100 disabled:pointer-events-none disabled:opacity-50 dark:text-neutral-200 dark:hover:bg-neutral-700 dark:focus:bg-neutral-700"
                            aria-haspopup="menu" aria-expanded="false" aria-label="Dropdown">
                            <span class="">
                                <svg class="size-4 shrink-0" xmlns="http://www.w3.org/2000/svg" width="24"
                                    height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor"
                        ...
                        <div class="hs-dropdown-menu hs-dropdown-open:opacity-100 min-w-90 md:w-125 duration z-61 hidden w-full overflow-hidden rounded-xl border border-gray-200 bg-white opacity-0 shadow-xl transition-[opacity,margin] dark:border-neutral-700 dark:bg-neutral-800"
                            ...
                            <!-- Tab Content -->
                            <div id="hs-pms-free" class="" role="tabpanel"
                    ...
                    <div class="flex flex-wrap items-center justify-between gap-2">
                        ...
                        <div>
                            <span
                                ...
                                <svg class="inline-block size-3.5" xmlns="http://www.w3.org/2000/svg"
                                    width="24" height="24" viewBox="0 0 24 24" fill="none"
                                    stroke="currentColor" stroke-width="2" stroke-linecap="round"
                                    stroke-linejoin="round">
                                    <path d="M12 5v14" />
