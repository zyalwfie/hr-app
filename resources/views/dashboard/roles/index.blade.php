                                        ...
                                        <td class="whitespace-nowrap">
                                            <div class="py-3 pe-6 ps-6">
                                                <div class="flex items-center gap-x-3">
                                                    <span
                                                        class="block text-sm text-gray-800 dark:text-neutral-200">{{ $role->title }}</span>
                                                </div>
                                            </div>
                                        </td>
                    ...
                    <div class="relative max-w-xs rounded-xl border border-gray-200 bg-white shadow-lg dark:border-neutral-700 dark:bg-neutral-800 overflow-hidden"
                        ...
                        <div class="flex p-4">
                            ...
                            <div class="ms-2 me-5">
                                ...
                                <form action="/dashboard/roles/${window.__restorableId}/restore" method="post" class="mt-3">
