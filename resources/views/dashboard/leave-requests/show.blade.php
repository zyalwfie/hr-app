<x-dashboard-layout>
    <x-slot name="title">
        Dashboard | Presence - Show, {{ $leave_request->employee->fullname }}
    </x-slot>
                        ...
                        <div class="flex flex-col gap-y-4 xl:flex-row xl:items-center xl:justify-between">
                            <div class="order-2 xl:order-1">
                                ...
                                <h3 class="font-medium text-gray-800 dark:text-neutral-200">
                                    {{ $leave_request->employee->fullname }}
                                </h3>
                            </div>
                            @session('success')
                                <div id="dismiss-alert"
                                    ...
                                    <div class="flex w-72 min-w-max items-center">
                                        <div class="shrink-0">
                        ...
                        <div class="my-4 grid grid-cols-2 gap-x-2 gap-y-4 xl:grid-cols-3">
                            ...
                            <div class="flex flex-col gap-y-1">
                                ...
                                <div class="flex items-center gap-x-1.5">
                                    ...
                                    <span class="text-sm font-medium text-gray-800 dark:text-neutral-200">
                                        {{ $leave_request->start_date->format('M d, Y') }}
                                    </span>
                                </div>
                            </div>
                            <!-- End Item -->
                            ...
                            <div class="flex flex-col gap-y-1">
                                ...
                                <div class="flex items-center gap-x-1.5">
                                    ...
                                    <span class="text-sm font-medium text-gray-800 dark:text-neutral-200">
                                        {{ $leave_request->end_date->format('M d, Y') }}
                                    </span>
                                </div>
                            </div>
                            <!-- End Item -->
                            ...
                            <div class="flex flex-col gap-y-1">
                                ...
                                <div class="flex items-center gap-x-1.5">
                                    ...
                                    <span class="text-sm font-medium capitalize text-gray-800 dark:text-neutral-200">
