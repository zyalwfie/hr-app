                    ...
                    <div class="sm:col-span-9">
                        <div class="sm:flex">
                            ...
                            <select
                                ...
                                <option selected value="mobile" {{ old('phone_number_type') == 'mobile' ? 'selected' : '' }}>Mobile</option>
                                <option value="home" {{ old('phone_number_type') == 'home' ? 'selected' : '' }}>Home</option>
                                <option value="work" {{ old('phone_number_type') == 'work' ? 'selected' : '' }}>Work</option>
                                <option value="fax" {{ old('phone_number_type') == 'fax' ? 'selected' : '' }}>Fax</option>
                            </select>
                        </div>
                    </div>
                    <!-- End Col -->
