                ...
                <div class="grid gap-2 py-8 pt-0 last:pb-0 sm:grid-cols-12 sm:gap-4">
                    ...
                    <div class="sm:col-span-9">
                        ...
                        <div class="flex rounded-lg">
                            ...
                            <div class="relative w-full">
                                <input type="text" id="bonuses" name="bonuses" value="{{ old('bonuses') }}"
                    ...
                    <div class="sm:col-span-9">
                        <div class="relative">
                            <input type="text" name="pay_date" id="pay_date"
                                ...
                                placeholder="Define pay date" value="{{ old('pay_date') }}">
                            @error('paydate')
                            ...
                            @enderror
                            <div class="pointer-events-none absolute inset-y-0 end-0 flex items-center pe-3 text-gray-500">
