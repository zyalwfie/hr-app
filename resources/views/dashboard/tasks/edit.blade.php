                ...
                <div
                    ...
                    <div class="sm:col-span-9">
                        <div class="relative w-full">
                            <input name="title" value="{{ old('title', $task->title) }}" id="title" type="text"
                    ...
                    <div class="sm:col-span-9">
                        <div class="relative w-full">
                            <textarea name="description" id="description"
                                ...
                                rows="6" placeholder="Add description for detail task.">{{ old('description', $task->description) }}</textarea>
                            @error('description')
